...
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(Counter, _Component);
  ...
  function Counter() {
    ...
    _this = Object(possibleConstructorReturn["a" /* default */])(this, (_getPrototypeOf2 = Object(getPrototypeOf["a" /* default */])(Counter)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "decrement", function () {
      var decrementCount = _this.props.decrementCount;
      decrementCount();
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "reset", function () {
...
var counter_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return Object(external_redux_["bindActionCreators"])({
    incrementCount: store["b" /* incrementCount */],
    decrementCount: store["a" /* decrementCount */],
    resetCount: store["d" /* resetCount */]
  }, dispatch);
};

/* harmony default export */ var counter = (Object(external_react_redux_["connect"])(mapStateToProps, counter_mapDispatchToProps)(counter_Counter));
...
var pages_mapDispatchToProps = {
  startClock: store["f" /* startClock */]
};
/* harmony default export */ var pages = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(null, pages_mapDispatchToProps)(pages_Index));
